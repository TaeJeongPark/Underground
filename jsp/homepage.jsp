        ...
        <section class="content">
            ...
            <div class="realtimebox">
                <div class="chartnamebox">
                    <text class="titlename" onclick="sessiontest()">실시간 차트</text>
                </div>
                <!--현재 접속한 시간-->
                <div class="timebox">
            ...
            <div class="chartoption">
                ...
                <div class="chartrankbox">
                    <text class="chartrank"><%=data.getIndex()%>
                    </text>
                </div>
                <!-- 노래 이미지-->
                ...
                <div class="chartmusicnamebox">
                    <text class="chartmusicname"><%=data.getMusic_name()%>
                    </text>
                </div>
                <!-- 노래 아티스트-->
                <div class="chartmusicartistbox">
                    <text class="chartmusicartist"><%=data.getArtist_name()%>
                    </text>
                </div>
                <!-- 노래 장르-->
                <div class="chartgenrebox">
                    <text class="chartgenre"><%=data.getMusic_genre()%>
                    </text>
                </div>
                <!-- 노래 플레이 버튼-->
                <!--클릭 시 set_music() 함수를 통해 파라미터 전달-->
