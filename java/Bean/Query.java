...
public class Query {
    ...
    //음원 차트 (DB : "SELECT * FROM music ORDER BY play_cnt DESC")
    //배열로 반환
    ...
    //최신 앨범 (DB : "SELECT * FROM music ORDER BY regist_date DESC limit 5")
    //배열로 반환
    ...
    //검색 (DB : "WHERE music_name like 'string' or music_name like 'string%' or .... ")
    //배열로 반환
